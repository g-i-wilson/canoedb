...
public class StringMap2D<T> {
	...
	// write
	public StringMap2D write (String a, String b, T t) {
		if (! map.containsKey(a)) map.put(a, new LinkedHashMap<String, T>());
		map.get(a).put(b, t);
		mapChanged = true;
		return this;
	}
	public StringMap2D write (String a, Map<String, T> m) {
		map.put(a, m);
		mapChanged = true;
		return this;
	}
	...
	// vivify
	public StringMap2D vivify (String a) {
		if (! map.containsKey(a)) map.put(a, new LinkedHashMap<String, T>());
		mapChanged = true;
		return this;
	}
	public StringMap2D vivify (String a, String b) {
		if (! map.containsKey(a)) map.put(a, new LinkedHashMap<String, T>());
